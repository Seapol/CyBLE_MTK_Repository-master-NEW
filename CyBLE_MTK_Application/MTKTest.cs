...
namespace CyBLE_MTK_Application
{
    public enum MTKTestError { NoError, ReceivedNAC, MissingDUT, TestFailed, NoConnectionModeSet, MissingDUTSerialPort,
        MissingMTKSerialPort, UnknownError, MissingAnritsuSerialPort, IgnoringDUT, NotAllDevicesProgrammed, ProgrammerNotConfigured, Pending, ProcessCheckFailure };
    ...
    : this(Logger)
        ...
        public void UpdateMTKHostPort(SerialPort HostPort)
        {
            MTKSerialPort = HostPort;
        }
